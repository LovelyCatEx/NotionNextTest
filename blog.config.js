...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LovelyCatV', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名Android开发者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lovelycatv.cn', // 网站地址
